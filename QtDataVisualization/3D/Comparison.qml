...
Window {
    ...
    property bool isOrthoProjection: is2D ? true : false // ortho or perspective view
    property int cameraPreset: is2D ? Camera3D.CameraPresetDirectlyAbove : Camera3D.CameraPresetIsometricLeftHigh
